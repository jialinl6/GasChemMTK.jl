...
function EarthSciMLBase.couple2(
    ...
    @constants(
        ...
        [unit = u"kg/mol", description = "Isoprene molar mass"],
        MW_SULF = 98.079e-3,
        [unit = u"kg/mol", description = "H2SO4; Sulfuric acid"],
        MW_C2H4 = 28.054e-3,
        [unit = u"kg/mol", description = "C2H4; Ethylene"],
        MW_C2H6 = 30.07e-3,
        [unit = u"kg/mol", description = "C2H6; Ethane"],
        MW_C2H2 = 26.038e-3,
        [unit = u"kg/mol", description = "C2H2; Acetylene"],
        MW_C3H8 = 44.096e-3,
        [unit = u"kg/mol", description = "C3H8; Propane"],
        MW_TOLU = 92.141e-3,
        [unit = u"kg/mol", description = "C7H8; Toluene"],
        MW_MOH = 32.042e-3,
        [unit = u"kg/mol", description = "CH3OH; Methanol"],
        MW_EOH = 46.069e-3,
        [unit = u"kg/mol", description = "C2H5OH; Ethanol"],
        MW_NAP = 128.174e-3,
        [unit = u"kg/mol", description = "C10H8; Naphthalene"],
        MW_HNO2 = 47.014e-3,
        [unit = u"kg/mol", description = "HONO; Nitrous acid"],
        MW_HCl = 36.461e-3,
        [unit = u"kg/mol", description = "HCl; Hydrochloric acid"],
        MW_Cl2 = 70.906e-3,
        [unit = u"kg/mol", description = "Cl2; Molecular chlorine"],
        MW_CO2 = 44.01e-3,
        [unit = u"kg/mol", description = "CO2; Carbon dioxide"],
        MW_N2O = 44.013e-3,
        [unit = u"kg/mol", description = "N2O; Nitrous oxide"],
        MW_XYLE = 106.167e-3,
        [unit = u"kg/mol", description = "C8H10; Xylene (lumped)"],
        MW_MTPA = 136.234e-3,
        [unit = u"kg/mol", description = "C10H16; Monoterpenes"],
        MW_RCHO = 58.08e-3,
        [unit = u"kg/mol", description = "C2H5CHO; Propionaldehyde"],
        MW_PRPE = 42.081e-3,
        [unit = u"kg/mol", description = "C3H6; Propylene"],
        MW_ALK4 = 58.12e-3,
        [unit = u"kg/mol", description = "Lumped C4+C5 alkanes"],
        MW_HNO4 = 79.01e-3,
        [unit = u"kg/mol", description = "HNO4; Peroxynitric acid"],
        MW_MEK = 72.107e-3,
        [unit = u"kg/mol", description = "C4H8O; Methyl ethyl ketone"],
        MW_Air = 28.97e-3,
        [unit = u"kg/mol", description = "Molar mass of air"],
        nmolpermol = 1.0e9,
        [unit = u"ppb", description = "nmol/mol, Conversion factor from mol to nmol"],
...
function EarthSciMLBase.couple2(
    ...
    # GEOS-Chem met-driven fixed-species treatment) coupled from GEOSFP meteorology via
    # param_to_var, same as SuperFast. This drives the explicit O1D + H2O --> 2OH OH
    # source with real per-cell humidity instead of a frozen boundary-layer constant.
    @constants(
        R = 8.31446261815324,
    ...
    return ConnectorSystem(
        [
            ...
            c.H2O ~ water_concentration_ppb(
                gfp.A3dyn₊RH, gfp.P * P_inv, gfp.I3₊T * T_inv
            ) * ppb_unit,
        ], c, gfp
    )
end
